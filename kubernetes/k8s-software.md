### Install helm
```bash
curl -L "https://get.helm.sh/helm-v3.11.0-linux-amd64.tar.gz" -o helm-linux-amd64.tgz && \
...
### Install datree
```bash
curl -L "https://github.com/datreeio/datree/releases/download/1.8.21/datree-cli_1.8.21_Linux_x86_64.zip" -o datree-cli.zip && \
unzip datree-cli.zip datree && mv ./datree /usr/local/bin/ && rm -f datree-cli.zip
```

### Install kubescape
```bash
curl -L "https://github.com/kubescape/kubescape/releases/download/v2.0.183/kubescape-ubuntu-latest" -o kubescape && \
...
```
```bash
curl -L "https://github.com/containerd/nerdctl/releases/download/v1.2.0/nerdctl-1.2.0-linux-amd64.tar.gz" -o nerdctl-linux-amd64.tgz && \
