### Install helm
```bash
curl -L "https://get.helm.sh/helm-v3.11.2-linux-amd64.tar.gz" -o helm-linux-amd64.tgz && \
...
### Install datree
```bash
curl -L "https://github.com/datreeio/datree/releases/download/1.8.49/datree-cli_1.8.49_Linux_x86_64.zip" -o datree-cli.zip && \
