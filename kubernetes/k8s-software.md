### Install helm
```bash
curl -L "https://get.helm.sh/helm-v3.12.3-linux-amd64.tar.gz" -o helm-linux-amd64.tgz && \
...
### Install kubescape
```bash
curl -L "https://github.com/kubescape/kubescape/releases/download/v2.3.8/kubescape-ubuntu-latest" -o kubescape && \
...
```
```bash
curl -L "https://github.com/containerd/nerdctl/releases/download/v1.5.0/nerdctl-1.5.0-linux-amd64.tar.gz" -o nerdctl-linux-amd64.tgz && \
