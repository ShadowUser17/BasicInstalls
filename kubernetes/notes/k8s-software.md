#### Install helm
```bash
curl -L "https://get.helm.sh/helm-v3.13.1-linux-amd64.tar.gz" -o helm-linux-amd64.tgz && \
...
#### Install kubectl
```bash
curl -LO "https://storage.googleapis.com/kubernetes-release/release/v1.26.9/bin/linux/amd64/kubectl" && \
